...
def get_args():
    ...
    if args.threads:
        ...
        os.environ["OMP_NUM_THREADS"] = str(num_threads) #onxx backend
        os.environ["OPENBLAS_NUM_THREADS"] = str(num_threads)
        os.environ["MKL_NUM_THREADS"] = str(num_threads)
        os.environ["TF_NUM_INTRAOP_THREADS"] = str(num_threads) #tensorflow
        os.environ["TF_NUM_INTEROP_THREADS"] = str(num_threads) 
        os.environ["TVM_NUM_THREADS"] = str(num_threads) #tvm backend
        os.environ["TFLITE_NUM_THREADS"] = str(num_threads) #tflite backend
        os.environ["NCNN_NUM_THREADS"] = str(num_threads)  #ncnn backend
    return args
